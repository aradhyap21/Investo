...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Profile dropdown functionality - Fixed implementation
  ...
  // Add animation to investment values (improved counter animation)
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    setTimeout(() => {
      if (totalInvestment) animateValue(totalInvestment, 0, 1545000, 2000)
      if (currentValue) animateValue(currentValue, 0, 1782000, 2000)
    }, 1500)
  })
